...
export default defineBackground(() => {
  ...
  // Browser-level shortcuts (chrome://extensions/shortcuts) — forwarded to
  // the content script in the active tab. Sheets can't swallow these.
  const COMMAND_ACTIONS: Record<string, string> = {
    'open-navi': OPEN_NAVI_ACTION,
    'navi-help': HELP_NAVI_ACTION,
    'navi-menu': MENU_NAVI_ACTION,
  };
